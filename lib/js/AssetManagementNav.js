function AssetManagementNav(params){
	...
	// Call that function, and get returned an array of documents.// Put each of the elements into the Div Tag created in step 1.
	...
	// This goes onto Main
	if (params.main_section_params.hasOwnProperty("fields")) {
		Helper.require('./lib/js/AssetManagementField.js', function() {
			for (var i = 0; i < params.main_section_params.fields.length; i++) {
				var field = new AssetManagementField();
				
				managementNav.main.element.appendChild(field.element);
			}
		});
	}
